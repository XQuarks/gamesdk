...
public class InputConnection extends BaseInputConnection implements View.OnKeyListener {
  ...
  private void fixEditorInfo() {
    if (settings.mEditorInfo.initialSelStart == -1 && settings.mEditorInfo.initialSelEnd == -1) {
      // GBoard bug. If it is initialized with -1, -1 it doesn't work with deletion of selection.
      //      settings.mEditorInfo.initialSelStart = 0;
      //      settings.mEditorInfo.initialSelEnd = 0;
    }
  }
