...
typedef struct __attribute__((
    packed)) Paddleboat_Controller_Mapping_File_Header {
  ...
  /** @brief The number of button remapping table entries present in the file.
   * The button remapping table is a sequential array of
   ...
   * in the file. The controller mapping definition table is a sequential array
   * of `Paddleboat_Controller_Mapping_File_Controller_Entry` structures
   * starting at `controllerTableOffset` bytes from the beginning of this
   * header.
   */
 ...
 */
typedef struct __attribute__((
    packed)) Paddleboat_Controller_Mapping_File_Axis_Entry {
 ...
 */
typedef struct __attribute__((
    packed)) Paddleboat_Controller_Mapping_File_Button_Entry {
  /** @brief Index into the file's string table for the entry
 ...
 */
typedef struct __attribute__((
    packed)) Paddleboat_Controller_Mapping_File_Controller_Entry {
 ...
 */
typedef struct __attribute__((
    packed)) Paddleboat_Controller_Mapping_File_String_Entry {
